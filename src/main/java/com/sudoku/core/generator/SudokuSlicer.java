...
public final class SudokuSlicer {
	...
	public static int[][] getCurrentSubSection(int[][] sudoku, int leftIndex, int rightIndex) {
		...
		if (leftIndex < 3 && rightIndex < 3) {
			currentSection = new int[][] { new int[] { sudoku[0][0], sudoku[0][1], sudoku[0][2] },
			...
			currentSection = new int[][] { new int[] { sudoku[3][0], sudoku[3][1], sudoku[3][2] },
			...
			currentSection = new int[][] { new int[] { sudoku[6][0], sudoku[6][1], sudoku[6][2] },
					new int[] { sudoku[7][0], sudoku[7][1], sudoku[7][2] },
					new int[] { sudoku[8][0], sudoku[8][1], sudoku[8][2] } };
		}
		if (leftIndex < 3 && rightIndex >= 3 && rightIndex < 6) {
			currentSection = new int[][] { new int[] { sudoku[0][3], sudoku[0][4], sudoku[0][5] },
			...
			currentSection = new int[][] { new int[] { sudoku[3][3], sudoku[3][4], sudoku[3][5] },
			...
			currentSection = new int[][] { new int[] { sudoku[6][3], sudoku[6][4], sudoku[6][5] },
					new int[] { sudoku[7][3], sudoku[7][4], sudoku[7][5] },
					new int[] { sudoku[8][3], sudoku[8][4], sudoku[8][5] } };
		}
		if (leftIndex < 3 && rightIndex >= 6 && rightIndex < 9) {
			currentSection = new int[][] { new int[] { sudoku[0][6], sudoku[0][7], sudoku[0][8] },
			...
			currentSection = new int[][] { new int[] { sudoku[3][6], sudoku[3][7], sudoku[3][8] },
			...
			currentSection = new int[][] { new int[] { sudoku[6][6], sudoku[6][7], sudoku[6][8] },
