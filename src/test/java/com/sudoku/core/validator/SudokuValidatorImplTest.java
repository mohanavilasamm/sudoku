...
class SudokuValidatorImplTest {
	...
	void testValidate() {
		...
		assertFalse(validator.validate(new int[][] {new int[]{1,2,3}, new int[]{4,5,6}, new int[]{7,8,9}}));
		assertTrue(validator.validate(new int[][] {
	...
	void testIsSubSectionValid() {
		...
		assertFalse(validator.isValidSubSection(new int[][] {new int[]{1,1,3}, new int[]{4,5,6}, new int[]{7,8,9}}));
		assertFalse(validator.isValidSubSection(new int[][] {new int[]{1,1,3}, new int[]{4,5,6}}));
		assertFalse(validator.isValidSubSection(new int[][] {new int[]{1,1,3,4}, new int[]{4,5,6}, new int[]{7,8,9}}));
		assertTrue(validator.isValidSubSection(new int[][] {new int[]{1,2,3}, new int[]{4,5,6}, new int[]{7,8,9}}));
	}
